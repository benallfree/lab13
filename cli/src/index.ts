...
program
  ...
  .option('--terser-mangle-props', 'Enable Terser property mangling')
  ...
  .option('--ect', 'Enable ECT compression', true)
  .option('--no-ect', 'Disable ECT compression')
  .option('--zopfli', 'Enable Zopfli compression', true)
  .option('--no-zopfli', 'Disable Zopfli compression')
...
program
  ...
  .option('--terser', 'Enable Terser minification', true)
  .option('--no-terser', 'Disable Terser minification')
  .option('--terser-mangle-props', 'Enable Terser property mangling', true)
  .option('--no-terser-mangle-props', 'Disable Terser property mangling')
  .option('--inline-css', 'Inline CSS assets into HTML', true)
  .option('--no-inline-css', 'Disable inlining CSS assets into HTML')
  .option('--inline-js', 'Inline JS assets into HTML', true)
  .option('--no-inline-js', 'Disable inlining JS assets into HTML')
